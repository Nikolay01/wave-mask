...
var triangle = function (attributes, src, maskId) {
    var triangle = el('polygon', {
        points:  attributes.width / 2 + ',20' + ' ' + attributes.width + ',' + attributes.height + ' ' + '0,' + attributes.height,
        fill: '#fff'
    });
    return createMaskSvg(attributes, src, triangle, maskId);
}
